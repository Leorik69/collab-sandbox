...
/// <summary>Visual-free overlay state. Transitions, timers, invalid-data sanitizing.</summary>
public sealed class OverlayMachine
{
    ...
    private void RunDemoStep()
    {
        var steps = new OverlayCommand[]
        {
            ...
            OverlayCommand.SetProgress,
            OverlayCommand.SetMedia,
            OverlayCommand.SetTimer,
            OverlayCommand.SetError
        };
        ...
        var sample = cmd switch
        {
            ...
            OverlayCommand.SetMedia => new OverlayPayload
            {
                Title = "Night Drive",
